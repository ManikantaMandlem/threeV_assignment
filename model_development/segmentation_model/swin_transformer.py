# Inspired/ Extracted from open source Timm (huggingface - Pytorch Image Library) models
# Source: https://github.com/huggingface/pytorch-image-models/blob/main/timm/models/swin_transformer.py
# And Ashish-s-bisht: https://github.com/ashish-s-bisht/SwinUnetArchitecturePytorch?tab=readme-ov-file
